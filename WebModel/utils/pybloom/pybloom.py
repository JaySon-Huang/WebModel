...
import math
import hashlib
from WebModel.utils.pybloom.utils import range_fn, is_string_io, running_python_3
from struct import unpack, pack, calcsize

try:
    import WebModel.utils.bitarray
except ImportError:
...
class BloomFilter(object):
    ...
    def __init__(self, capacity, error_rate=0.001):
        ...
        self.bitarray = WebModel.utils.bitarray.bitarray(self.num_bits, endian='little')
